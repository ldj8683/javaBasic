	...
	<body>
		...
		<nav id="Content" style="background:#16b4f7;"> <!-- 각 조원들이 넣게될 본문 레이아웃 생성 -->	
			...
			<table id="registerForm" style="padding:20px; font-size: 15px; font-weight: bold;">
				<tr>
					<td width="85" height="25" style="text-align:right">등록된 번호:</td>
					<td><%= bag.getProductNum() %></td>
				</tr>
				<tr>
					<td width="85" height="25" style="text-align:right">등록된 이름:</td>
					<td><%= bag.getProductName() %>	</td>
				</tr>
				<tr>
					<td width="85" height="25" style="text-align:right">등록된 주소:</td>
					<td><%= bag.getProductLocation() %></td>
				</tr>
