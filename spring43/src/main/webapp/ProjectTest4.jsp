			...
			$('#btn1').click(function() {
				$.ajax({
					...
					success: function(json) {
						...
						console.log("0대 >> " + mAge0)
						console.log("0대 >> " + fAge0)
						console.log("10대 >> " + mAge10)
						console.log("10대 >> " + fAge10)
						console.log("20대 >> " + mAge20)
						console.log("20대 >> " + fAge20)
						console.log("30대 >> " + mAge30)
						console.log("30대 >> " + fAge30)
						console.log("40대 >> " + mAge40)
						console.log("40대 >> " + fAge40)
						console.log("50대 >> " + mAge50)
						console.log("50대 >> " + fAge50)
						console.log("60대 이상 >> " + mAge60)
						console.log("60대 이상 >> " + fAge60)
						mAgeAll = mAge0 + mAge10 + mAge20 + mAge30 + mAge40 + mAge50 + mAge60
						fAgeAll = fAge0 + fAge10 + fAge20 + fAge30 + fAge40 + fAge50 + fAge60
						console.log("총인원 >> " + mAgeAll)
						console.log("총인원 >> " + fAgeAll)
